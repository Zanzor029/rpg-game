...
import { equipItemFromInventory, sellInventoryItem, getInventoryItems } from '../../../actions/worldActions'
                        ...
                        <Table hover responsive size="sm" bordered variant="dark">
                            ...
                            <tbody>
                                {this.props.reduxinventory.map(item => (
                                    <tr key={item.Id} id={"InventoryTablerow-" + item.ItemId}
                                    ...
                                    >
                                        ...
                                        <td><Button variant="danger" size ="sm" onClick={() => this.props.sellInventoryItem(item)}>Sell Item ({`${item.GoldValue} Gold`})</Button></td>
                                    </tr>
                                ))}
                            </tbody>
...
export default connect(mapStateToProps, { getInventoryItems, equipItemFromInventory, showTooltip, hideTooltip, sellInventoryItem })(withRouter(Inventory))
